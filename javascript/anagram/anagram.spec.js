...
describe('Anagram', function() {
  ...
  // it("detects anagrams case-insensitively 2.0",function() {
  //   var subject = anagram("Beaver");
  //   var matches = subject.matches(['cashregister', 'veebar', 'radishes']);

  //   expect(matches).toEqual(['veebar']);
  // });  
